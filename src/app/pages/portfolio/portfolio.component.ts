...
export class PortfolioComponent implements OnInit {
  ...
  words: string[] = ['Hiren Khunt', 'Developer', 'Engineer ', 'Programmer'];
  wordIndex: number = 0;
  charIndex: number = 0;
  ...
  works = [
    ...
    {
      header: 'Mandali Financial System ',
      desc: 'Built a web app with role-based access, real-time stock tracking, investment management, and user activity logging.',
      img: 'mandali',
    },
  ];
  about = {
    ...
    educations: [
      {
        post: 'B.Tech (Computer Engineering)',
        time: ' (2019-2023)',
        value: `College - Indus University`,
      },
    ],
  };
  contactDetails = {
    email: 'hirenkhunt101@gmail.com',
    phone: '+916351869907',
    linkedin: 'https://www.linkedin.com/in/hiren-khunt-730807218/',
    instagram: 'https://www.instagram.com/hiren_patel_1.0/',
    whatsapp: 'https://api.whatsapp.com/send?phone=916351869907',
    facebook:
      'https://www.facebook.com/profile.php?id=100014223515614',
    cv: '/assets/Images/my-cv.pdf',
    name: 'Hiren Khunt',
    github: 'https://github.com/HirenKhunt101'
  };
